...
def connect_gsheet():
  ...
  df["full-text"] = df[["abstract", "introduction", "methods", "result & discussion", "conclusion"]].agg(" - ".join, axis=1)
  return df
...
# option to choose
part_opt = ["author", "title", "abstract", "introduction", "methods", "result & discussion", "conclusion", "full-text"]
